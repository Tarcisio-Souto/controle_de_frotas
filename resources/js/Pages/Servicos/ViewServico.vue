<template>
  <layout>
    ...
    <div class="row">
      <div class="col-md-12">
        <form v-for="servico in servico" :key="servico.id">          
          <br /><br />
          ...
          <div class="row">
            <div class="col-md-12">
              <Link :href="'/servico/editar/'+servico.id" class="btn btn-warning">Editar</Link>
...
export default {
  ...
  methods: {
    sendForm() {
      this.$inertia.post("/servico/registrar", this.form, {
        forceFormData: true,
