<template>
  <layout>
    ...
    <div class="row">
      <div class="col-md-12">
        <form
          v-for="servico in servico"
          :key="servico.id"
          @submit.prevent="sendForm"
          enctype="multipart/form-data"
        >
          <input type="hidden" v-model="servico.id" />        
          <br /><br />
            ...
            <div class="col-md-12">
              ...
              <div class="input-group">
                ...
                <input
                  ...
                  id="inputNome"
                  class="form-control"
                  v-model="form.descricao_servicos"
                />
              </div>
...
export default {
  ...
  created() {
    (this.form.id = this.$page.props.servico[0].id),
      (this.form.descricao_servicos = this.$page.props.servico[0].descricao_servicos)      
  },

  methods: {
    sendForm() {
      this.$inertia.post("/servico/update/" + this.form.id, this.form, {
        forceFormData: true,
