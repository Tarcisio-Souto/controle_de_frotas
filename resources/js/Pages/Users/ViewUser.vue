<template>
  <layout>
    ...
    <div class="row">
      <div class="col-md-12">
        <form v-for="colab in colab" :key="colab.us_id">          
          <br /><br />
            ...
            <div class="col-md-4">
              ...
              <div class="input-group">
                ...
                <select
                  ...
                  disabled
                >
                  <option selected>{{ colab.nome_emp }}</option>
                </select>
              </div>
            </div>
            <div class="col-md-4">
