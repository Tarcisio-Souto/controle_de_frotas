<template>
  <layout>
    ...
    <div class="row">
      <div class="col-md-12">
        <form
          v-for="fabricante in fabricante"
          :key="fabricante.id"
          @submit.prevent="sendForm"
          enctype="multipart/form-data"
        >
          <input type="hidden" v-model="fabricante.id" />        
          <br /><br />
...
export default {
  ...
  created() {
    (this.form.id = this.$page.props.fabricante[0].id),
      (this.form.nome = this.$page.props.fabricante[0].nome_fabricante)      
  },

  methods: {
    sendForm() {
      this.$inertia.post("/fabricante/update/" + this.form.id, this.form, {
        forceFormData: true,
