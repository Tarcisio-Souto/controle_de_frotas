<template>
  <layout>
    ...
    <div class="row">
      <div class="col-md-12">
        <form v-for="fabricante in fabricante" :key="fabricante.id">          
          <br /><br />
          <h4><span style="font-weight: bold">Dados Cadastrais</span></h4>
          <div class="row">
            <div class="col-md-12">
              <label for="inputNome">Fabricante</label>
              <div class="input-group">
                ...
                <input
                  ...
                  id="inputNome"
                  class="form-control"
                  :value="fabricante.nome_fabricante"
                  disabled
                />
              </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <Link :href="'/fabricante/editar/'+fabricante.id" class="btn btn-warning">Editar</Link>
...
export default {
  ...
  methods: {
    sendForm() {
      this.$inertia.post("/fabricante/registrar", this.form, {
        forceFormData: true,
